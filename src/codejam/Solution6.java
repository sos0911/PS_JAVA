...
public class Solution6 {
	static String[] perm;
	static boolean[] Isthere; // distinct combs already formed
	static StringBuilder cur; // used in generating comb
	static boolean[] dfsvisit; // used in dfs
	static int index;
	 public static void main(String[] args) throws IOException{
		 BufferedReader br = new BufferedReader(new FileReader(new File("IO.txt")));
		 ...
		 outerloop:
		 for(int i=1;i<=t;i++){
			 perm=new String[120]; //0- combinations
